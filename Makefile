#############################################################################
# Makefile for building: easymove
# Generated by qmake (3.0) (Qt 5.3.0)
# Project:  easymove.pro
# Template: app
# Command: /usr/lib/qt/bin/qmake -o Makefile easymove.pro
#############################################################################
...
INCPATH       = -I/usr/lib/qt/mkspecs/linux-g++ -I. -isystem /usr/include/opencv -isystem /usr/include/qt -isystem /usr/include/qt/QtWidgets -isystem /usr/include/qt/QtGui -isystem /usr/include/qt/QtCore -I.
LINK          = g++
LFLAGS        = -Wl,-O1,--sort-common,--as-needed,-z,relro -Wl,-O1
LIBS          = $(SUBLIBS) -L/usr/lib/ -lopencv_core -lopencv_highgui -lopencv_imgproc -lcvblob -lQt5Widgets -lQt5Gui -lQt5Core -lGL -lpthread 
AR            = ar cqs
RANLIB        = 
...
SOURCES       = main.cpp \
		cvWindow.cpp \
		patch.cpp \
		patchDetection.cpp moc_cvWindow.cpp
OBJECTS       = main.o \
		cvWindow.o \
		patch.o \
		patchDetection.o \
...
DIST          = /usr/lib/qt/mkspecs/features/spec_pre.prf \
		...
		easymove.pro main.cpp \
		cvWindow.cpp \
		patch.cpp \
		patchDetection.cpp
QMAKE_TARGET  = easymove
...
Makefile: easymove.pro /usr/lib/qt/mkspecs/linux-g++/qmake.conf /usr/lib/qt/mkspecs/features/spec_pre.prf \
		/usr/lib/qt/mkspecs/common/shell-unix.conf \
		/usr/lib/qt/mkspecs/common/unix.conf \
		/usr/lib/qt/mkspecs/common/linux.conf \
		/usr/lib/qt/mkspecs/common/gcc-base.conf \
...
dist: 
	@test -d .tmp/easymove1.0.0 || mkdir -p .tmp/easymove1.0.0
	$(COPY_FILE) --parents $(DIST) .tmp/easymove1.0.0/ && $(COPY_FILE) --parents cvWindow.h patch.h patchDetection.h .tmp/easymove1.0.0/ && $(COPY_FILE) --parents main.cpp cvWindow.cpp patch.cpp patchDetection.cpp .tmp/easymove1.0.0/ && (cd `dirname .tmp/easymove1.0.0` && $(TAR) easymove1.0.0.tar easymove1.0.0 && $(COMPRESS) easymove1.0.0.tar) && $(MOVE) `dirname .tmp/easymove1.0.0`/easymove1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/easymove1.0.0
...
compiler_rcc_clean:
compiler_moc_header_make_all: moc_cvWindow.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_cvWindow.cpp
moc_cvWindow.cpp: patchDetection.h \
		patch.h \
		cvWindow.h
	/usr/lib/qt/bin/moc $(DEFINES) -I/usr/lib/qt/mkspecs/linux-g++ -I/home/cheker/easymove -I/usr/include/opencv -I/usr/include/qt -I/usr/include/qt/QtWidgets -I/usr/include/qt/QtGui -I/usr/include/qt/QtCore -I/usr/include/c++/4.9.0 -I/usr/include/c++/4.9.0/x86_64-unknown-linux-gnu -I/usr/include/c++/4.9.0/backward -I/usr/lib/gcc/x86_64-unknown-linux-gnu/4.9.0/include -I/usr/local/include -I/usr/lib/gcc/x86_64-unknown-linux-gnu/4.9.0/include-fixed -I/usr/include cvWindow.h -o moc_cvWindow.cpp
...
main.o: main.cpp cvWindow.h \
		patchDetection.h \
		patch.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o main.o main.cpp

cvWindow.o: cvWindow.cpp cvWindow.h \
		patchDetection.h \
		patch.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o cvWindow.o cvWindow.cpp

patch.o: patch.cpp patch.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o patch.o patch.cpp

patchDetection.o: patchDetection.cpp patchDetection.h \
		patch.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o patchDetection.o patchDetection.cpp

moc_cvWindow.o: moc_cvWindow.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o moc_cvWindow.o moc_cvWindow.cpp

####### Install

install_target: first FORCE
	@test -d $(INSTALL_ROOT)/opt/easymove/bin || mkdir -p $(INSTALL_ROOT)/opt/easymove/bin
	-$(INSTALL_PROGRAM) "$(QMAKE_TARGET)" "$(INSTALL_ROOT)/opt/easymove/bin/$(QMAKE_TARGET)"
	-$(STRIP) "$(INSTALL_ROOT)/opt/easymove/bin/$(QMAKE_TARGET)"

uninstall_target: FORCE
	-$(DEL_FILE) "$(INSTALL_ROOT)/opt/easymove/bin/$(QMAKE_TARGET)"
	-$(DEL_DIR) $(INSTALL_ROOT)/opt/easymove/bin/ 
